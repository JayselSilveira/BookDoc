...
if(isset($_POST['Signup'])){
   ...
   if($count2 == 1) {
      ...
      $sql = "INSERT INTO users(user, username, birth_date, location, image, contact,  email_id, password) VALUES(2, '$user_name', '$birth_date', '$location', '$image', '$contact', '$email_id', '$password');";
...
<html>
   ...
   <body>
      ...
      <div class="wrapper" style="height: 95%; margin-top: 200px">
         ...
         <div class="form-container">
            <div class="form-inner">
               <form action="register.php" method="post" class="signup" enctype="multipart/form-data">
                  <div class="field">
                     <p>First Name:
                  ...
                  <div class="field">
                     <p>Date of Birth:
                        <input type="date" name="birth_date" max="<?php echo (new DateTime('today'))->format('Y-m-d'); ?>" required>
                     </p>
                  </div>
                  <div class="field">
