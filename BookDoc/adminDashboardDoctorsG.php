<?php
 ...
 if($row8['user'] == 'doctor'){
  ...
  $sql2 = "SELECT * FROM users where user = 3;";
      ...
      <div id="patient" class="tabcontent" style="margin-left:18%; margin-top:6%;">
        <section class="patients">
          ...
          <div class="title">
            ...
            <div class="filter">
                ...
                <form action="adminDashboardDoctorsG.php" method="post" enctype="multipart/form-data">
                  <div class="field">
        ...
        <div id="grid">
          ...
          <div class="card" style="display:inline-block; color:teal; background-color:#c2fcf6; font-size:15px; margin-top:2%; margin-bottom:2%; margin-left:3%; margin-right:5%; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition:0.3s; width:25%; height:37%; text-align:center;">
            <table>
              <tr>
                ...
                <td rowspan="2">              
                  ...
                  <form action="adminDashboardDoctorsG.php?id=<?php echo $rows4['user_id'];?>" id="delete" method="post">
                    <a href="adminDashboardDoctorsG.php?id=<?php echo $rows4['user_id'];?>">
            ...
            <div class="container">
              ...
              Specialization: <?php echo $rows4['specialization'];?><br>
        ...
        <div class="card" style="display:inline-block; color:teal; background-color:#c2fcf6; font-size:15px; margin-top:2%; margin-bottom:2%; margin-left:3%; margin-right:5%; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition:0.3s; width:25%; height:37%; text-align:center;">
            <table>
              <tr>
                ...
                <td rowspan="2">              
                  ...
                  <form action="adminDashboardDoctorsG.php?id=<?php echo $rows5['user_id'];?>" id="delete" method="post">
                    <a href="adminDashboardDoctorsG.php?id=<?php echo $rows5['user_id'];?>">
            ...
            <div class="container">
              ...
              Specialization: <?php echo $rows5['specialization'];?><br>
        ...
        <div class="card" style="display:inline-block; color:teal; background-color:#c2fcf6; font-size:15px; margin-top:2%; margin-bottom:2%; margin-left:3%; margin-right:5%; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition:0.3s; width:25%; height:37%; text-align:center;">
            <table>
              <tr>
                ...
                <td rowspan="2">              
                  ...
                  <form action="adminDashboardDoctorsG.php?id=<?php echo $rows2['user_id'];?>" id="delete" method="post">
                    <a href="adminDashboardDoctorsG.php?id=<?php echo $rows2['user_id'];?>">
            ...
            <div class="container">
              ...
              Specialization: <?php echo $rows2['specialization'];?><br>
